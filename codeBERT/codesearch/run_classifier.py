...
MODEL_CLASSES = {'roberta': (RobertaConfig, RobertaForSequenceClassification, RobertaTokenizer), 'codet5': (T5Config, CodeT5ForSequenceClassification, RobertaTokenizer)}
    ...
    for idx, _ in enumerate(train_iterator):
        ...
        if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
            ...
            if args.model_type == 'codet5':
                torch.save(model_to_save, last_output_dir + '/pytorch_model.bin')
            else:
...
def main():
    ...
    parser.add_argument("--lang", default='java', type=str, help='target program language')
...
#    sys.exit()
    ...
    if args.model_type == 'codet5':
        logger.info('codet5')
        encoder = T5EncoderModel.from_pretrained('Salesforce/codet5-base')
        ...
        model = model_class.roberta.from_pretrained(args.model_name_or_path)
